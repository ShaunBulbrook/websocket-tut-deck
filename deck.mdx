...
```notes
Welcome.
Remember to launch the gameserver and the chatserver
```
---
...
---
```bash
git clone https://github.com/ShaunBulbrook/socket-tut-chat-input.git
...
//
this.socket = io('http://10.193.176.165:4001');
...
<img src="./images/chatserverimage.png" />
